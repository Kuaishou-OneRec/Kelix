...
def _register_keye_tokenizer_end2end_image():
    """Register KeyeTokenizerEnd2EndImage in the model registry."""
    try:
        from muse.models import register_model
        # Register the model    
        register_model("KeyeTokenizerEnd2EndImage")(KeyeTokenizerEnd2EndImage)
    except ImportError:
...
__all__ = [ "KeyeTokenizerEnd2EndImage"]
