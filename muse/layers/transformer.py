    ...
    def forward(
        ...
        **kwargs,
        ...
        Args:
            ...
            **kwargs: Additional arguments passed to the attention layer. Common kwargs include:
                ...
                Other transformer layer inputs not relevant to self attention will be ignored.
        ...
        **kwargs,
        ...
        Args:
            ...
            encoder_mask (Optional[torch.Tensor]):  Boolean tensor defining a relational matrix between
                ...
                Default is None.
            **kwargs: Additional arguments passed to the attention layer.
                Note: Cross attention typically doesn't use positional embeddings or sample packing.
        ...
        # Input tensor and attention output have the same shape
        # [b, s, d]
        # Norm applied before cross-attention
        # TODO: Add support for sample packing and bring back input_pos
        # Filter out transformer-specific kwargs that are not for attention
        attn_out = self.attn(
            self.ca_norm(x), encoder_input, mask=encoder_mask, **kwargs)
