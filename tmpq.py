...
class Qwen3Model(Qwen3PreTrainedModel):
    ...
    def forward(
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        _print("=" * 30)
        _print(len(position_embeddings))
        _print("=" * 30)
        _print(len(position_embeddings), len(position_embeddings[0]), len(position_embeddings[0][0])) # 2 3 1
        _print("=" * 30)
        _print(position_embeddings[0][0].shape)
        _print("=" * 30)
        _print(position_embeddings[0][0])
