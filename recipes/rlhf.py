...
def compute_rlhf_loss(
    ...
    if loss_style == "sample":
        batch_chosen_eos_rewards = get_eos_token_rewards(gathered_chosen_rewards, chosen_token_ids, chosen_sample_idx)
        batch_rejected_eos_rewards = get_eos_token_rewards(gathered_rejected_rewards, rejected_token_ids, rejected_sample_idx)
