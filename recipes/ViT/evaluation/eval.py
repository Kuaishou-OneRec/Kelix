...
def load_deepspeed_checkpoint(checkpoint_dir, model):
    client_state = model.load_checkpoint(
        ...
        tag="global_step225000",  # 自动查找最新检查点
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_dir", default="/llm_reco_ssd/zangdunju/output2/RecoVLM/SigLIP/3.0.0.1/", type=str, help="default checkpoint dir")
