...
# === 导入 Origin 模型 ===
from tests.models.tokenizer_end2end_mt_1drope_video.configuration_keye import KeyeConfig
from tests.models.tokenizer_end2end_mt_1drope_video.modeling_keye import KeyeForConditionalGeneration

# === 导入 Processor 相关 ===
from transformers import AutoTokenizer, AutoProcessor

try:
    from tests.models.tokenizer_end2end_mt_1drope_video.processing_keye import KeyeProcessor
