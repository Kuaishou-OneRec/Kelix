...
def generate_settings():
    ...
    add_configs({"vision_config.n_q_tokens":8, "vision_config.split_voc":8, "meta":'1.6.12', "vision_config.embedding_dim": 16})
    add_configs({"vision_config.n_q_tokens":16, "vision_config.split_voc":16, "meta":'1.6.14', "vision_config.embedding_dim": 128, "pool": "sum", "vision_config.add_voc_reducer": True})
