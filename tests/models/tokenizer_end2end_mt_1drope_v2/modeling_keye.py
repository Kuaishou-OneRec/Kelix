...
class SiglipAttention(nn.Module):
    ...
    def forward(
        ...
        # print("hid info", hidden_states.is_contiguous(), hidden_states.shape, hidden_states.stride())
        ...
        layer_outputs.append(
            {
                ...
                "self.k_proj.bias": self.k_proj.bias,
                "self.q_proj.bias": self.q_proj.bias,
                "self.v_proj.bias": self.v_proj.bias,
            }
        )
...
class KeyeImageTokenizer(PreTrainedModel):
    ...
    def forward(self,
        ...
        #     },
        #     save_path="/mmu_mllm_hdd_2/zhouyang12/output/Keye/vq_end2end_1105/run_exp1.6.6109_stage3/step9500/global_step9500/converted/debug_new/vq_outputs.pt"
        # )
        return {
            "codebook_loss": codebook_loss,
            "commitment_loss": commitment_loss,
