...
class SiglipEncoder(nn.Module):
    ...
    def forward(
        ...
        if use_rope is True:
            ...
            # Save inv_freq, rope_emb_max_grid, pids for debugging (use VIT-specific dict)
            _DEBUG_VIT_ROPE_OUTPUTS["inv_freq"] = self.rotary_pos_emb.inv_freq.detach()
            _DEBUG_VIT_ROPE_OUTPUTS["rope_emb_max_grid"] = rope_emb_max_grid.detach()
            _DEBUG_VIT_ROPE_OUTPUTS["pids"] = pids.detach()
...
# Global storage for debugging RoPE outputs (LLM RoPE)
_DEBUG_ROPE_OUTPUTS = {
    "inv_freq": None,
...
def apply_multimodal_rotary_pos_emb(q, k, cos, sin, mrope_section, unsqueeze_dim=1):
    ...
    # Debug: store cos/sin after split
    _DEBUG_ROPE_OUTPUTS["cos_after_chunk"] = cos.detach()
    _DEBUG_ROPE_OUTPUTS["sin_after_chunk"] = sin.detach()
