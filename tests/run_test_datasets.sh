...
mpirun --allow-run-as-root -np $np \
        ...
        python3 /llm_reco/maosiyang/msy_vit_2/recovlm/tests/test_datasets.py /llm_reco/maosiyang/msy_vit_2/recovlm/tests/files.txt /llm_reco/maosiyang/msy_vit_2/recovlm/tests/counter.txt