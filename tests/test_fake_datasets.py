...
def generate_test_dataframe(num_samples_perfile=400, num_files=30, n_texts=600, fake_dir="/llm_reco/lingzhixin/recovlm_0427compile/recovlm/tests/test_fake_datasets/generate_test_dataframe/buffer/"):
    """
    生成测试用DataFrame，结构如下：
