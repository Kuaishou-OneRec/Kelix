from recovlm.data.dataloaders import get_indexed_dataloader, get_webdataloader
...
def test_web_dataloader():
    ...
    for s in DataLoader(dataloader, batch_size=8, num_workers=8, collate_fn=collator):
        print(s)
        gg
