...
def main():
  ...
  output_dir = checkpoint_dir.rstrip("/") + "_torch_ckpt"
...
# 加载模型
llm = LLM(model= "/llm_reco/lingzhixin/output2/RecoVLM-dev/Qwen2-VL-7B-run_sft_7B_fsdp_sp/0.0.5/_1000/global_step_1000_torch_ckpt/")
