...
def get_shard_conditions(
    ...
    **kwargs,
    ...
    if model_class in ['Qwen2VLForConditionalGeneration', 'Qwen2_5_VLForConditionalGeneration','Qwen2_5_VLForConditionalGeneration_moonvit', "Qwen2_5_VLForConditionalGeneration_siglip", "Qwen2_5_VLForConditionalGeneration_siglip_navit"]:
...
def shard_model(
    ...
    *,
    ...
    if model_class == 'InternVLChatModel':
        ...
        assert model_class in ['Qwen2VLForConditionalGeneration', 'Qwen2_5_VLForConditionalGeneration','Qwen2_5_VLForConditionalGeneration_moonvit', "Qwen2_5_VLForConditionalGeneration_siglip", "Qwen2_5_VLForConditionalGeneration_siglip_navit"]
        layers = []
