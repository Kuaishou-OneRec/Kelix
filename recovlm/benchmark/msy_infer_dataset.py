...
from recovlm.models.qwen3siglip.processing_qwen3siglip import Qwen3SiglipProcessor_siglip,Qwen3SiglipProcessor_navit
  ...
  def __init__(self, 
    ...
    if model_name_or_path:
      try:
        ...
        self.processor = Qwen3SiglipProcessor_navit.from_pretrained(model_name_or_path)
