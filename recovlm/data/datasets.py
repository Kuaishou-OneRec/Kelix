...
from recovlm.models.qwen2_5_vl.processing_qwen2_5_vl import Qwen2_5_VLProcessor_moonvit
from recovlm.models.qwen2_5_vl.configuration_qwen2_5_vl import Qwen2_5_VLConfig
...
class ChatCompletionVisionDataset_moonvit(IterableDataset):
  def __init__(self,
               sources: Union[str, List[str]],
               max_length: int = 1024,
