...
class Qwen2VLPreTrainedModelV2(PreTrainedModel):
...
class Qwen2VisionTransformerPretrainedModel(Qwen2VLPreTrainedModelV2):
...
class Qwen2VLModelV2(Qwen2VLPreTrainedModelV2):
...
class Qwen2VLForConditionalGenerationV2(Qwen2VLPreTrainedModelV2, GenerationMixin):
    _tied_weights_keys = ["lm_head.weight"]

    def __init__(self, config):
        super().__init__(config)
        self.visual = Qwen2VisionTransformerPretrainedModel._from_config(config.vision_config)
        self.model = Qwen2VLModelV2(config)
        self.vocab_size = config.vocab_size
    ...
    def forward(
        ...
        **kwargs
        ...
        >>> import requests
        >>> from transformers import AutoProcessor, Qwen2VLForConditionalGenerationV2

        >>> model = Qwen2VLForConditionalGenerationV2.from_pretrained("Qwen/Qwen2-VL-7B-Instruct")
