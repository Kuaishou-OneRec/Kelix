#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/qwen3siglip/modular_qwen3siglip.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_qwen3siglip.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
# coding=utf-8
...
from .configuration_qwen3siglip import Qwen3SiglipConfig, Qwen3SiglipVisionConfig
...
class Qwen3SiglipPatchMerger(nn.Module):
...
class Qwen3SiglipVisionFlashAttention2(nn.Module):
...
class Qwen3SiglipVisionAttention(nn.Module):
    def __init__(self, dim: int, num_heads: int = 16) -> None:
        super().__init__()
        self.num_heads = num_heads
...
class Qwen3SiglipVisionSdpaAttention(nn.Module):
    def __init__(self, dim: int, num_heads: int = 16) -> None:
        super().__init__()
        self.num_heads = num_heads
        self.qkv = nn.Linear(dim, dim * 3, bias=True)
...
QWEN2_5_VL_VISION_ATTENTION_CLASSES = {
    "eager": Qwen3SiglipVisionAttention,
    "flash_attention_2": Qwen3SiglipVisionFlashAttention2,
    "sdpa": Qwen3SiglipVisionSdpaAttention,
}


class Qwen3SiglipVisionBlock(nn.Module):
    def __init__(self, config, attn_implementation: str = "sdpa") -> None:
        ...
        self.mlp = Qwen3SiglipMLP(config, bias=True)
...
@add_start_docstrings(
    "The bare Qwen3Siglip Model outputting raw hidden-states without any specific head on top.",
    Qwen3Siglip_START_DOCSTRING,
)
class Qwen3SiglipPreTrainedModel(PreTrainedModel):
    config_class = Qwen3SiglipConfig
    base_model_prefix = "model"
    supports_gradient_checkpointing = True
    _no_split_modules = ["Qwen3SiglipDecoderLayer", "Qwen3SiglipVisionBlock"]
...
class Qwen3VisionTransformerPretrainedModel(Qwen3SiglipPreTrainedModel):
    config_class = Qwen3SiglipVisionConfig
    _no_split_modules = ["Qwen3SiglipVisionBlock"]
    ...
    def __init__(self, config, *inputs, **kwargs) -> None:
        ...
        self.blocks = nn.ModuleList(
            [Qwen3SiglipVisionBlock(config, config._attn_implementation) for _ in range(config.depth)]
        )
        self.merger = Qwen3SiglipPatchMerger(
            dim=config.out_hidden_size, # lzx_mark: out_hidden_size
...
class Qwen3SiglipRotaryEmbedding(nn.Module):
    def __init__(self, config: Qwen3SiglipConfig, device=None):
        super().__init__()
        self.rope_kwargs = {}
        if config is None:
            logger.warning_once(
    ...
    def forward(self, x, position_ids):
        ...
        # Core RoPE block. In contrast to other models, Qwen3Siglip has different position ids for the grids
...
class Qwen3SiglipAttention(nn.Module):
    """
    Multi-headed attention from 'Attention Is All You Need' paper. Modified to use sliding window attention: Longformer
    and "Generating Long Sequences with Sparse Transformers".
    """

    def __init__(self, config: Qwen3SiglipConfig, layer_idx: Optional[int] = None):
        super().__init__()
        self.config = config
        ...
        self.rotary_emb = Qwen3SiglipRotaryEmbedding(config=config)
...
class Qwen3SiglipFlashAttention2(Qwen3SiglipAttention):
    """
    Qwen3Siglip flash attention module, following Qwen3Siglip attention module. This module inherits from `Qwen3SiglipAttention`
...
class Qwen3SiglipSdpaAttention(Qwen3SiglipAttention):
    """
    ...
    def forward(
        ...
        if output_attentions:
            ...
            logger.warning_once(
                "Qwen3SiglipModel is using Qwen3SiglipSdpaAttention, but `torch.nn.functional.scaled_dot_product_attention` does not support `output_attentions=True`. Falling back to the manual attention implementation, "
...
QWEN2_5_VL_ATTENTION_CLASSES = {
    "eager": Qwen3SiglipAttention,
    "flash_attention_2": Qwen3SiglipFlashAttention2,
    "sdpa": Qwen3SiglipSdpaAttention,
}


class Qwen3SiglipDecoderLayer(nn.Module):
...
class Qwen3SiglipModel(Qwen3SiglipPreTrainedModel):
    def __init__(self, config: Qwen3SiglipConfig):
        ...
        self.layers = nn.ModuleList(
            [Qwen3SiglipDecoderLayer(config, layer_idx) for layer_idx in range(config.num_hidden_layers)]
        )
            ...
            if attention_mask is not None and past_key_values is not None:
                ...
                if is_padding_right:
                    raise ValueError(
                        ...
                        " this may lead to unexpected behaviour for Flash Attention version of Qwen3Siglip. Make sure to "
...
@dataclass
class Qwen3SiglipCausalLMOutputWithPast(ModelOutput):
    """
    Base class for Qwen3Siglip causal language model (or autoregressive) outputs.
...
QWEN2_5_VL_INPUTS_DOCSTRING = r"""
    Args:
        ...
        pixel_values (`torch.FloatTensor` of shape `(seq_length, num_channels * image_size * image_size)):
            ...
            [`AutoImageProcessor`]. See [`Qwen3SiglipImageProcessor.__call__`] for details. [`Qwen3SiglipProcessor`] uses
            [`Qwen3SiglipImageProcessor`] for processing images.
        pixel_values_videos (`torch.FloatTensor` of shape `(seq_length, num_channels * temporal_size * image_size * image_size)):
            The tensors corresponding to the input videos. Pixel values can be obtained using
            [`AutoImageProcessor`]. See [`Qwen3SiglipImageProcessor.__call__`] for details. [`Qwen3SiglipProcessor`] uses
            [`Qwen3SiglipImageProcessor`] for processing videos.
...
class Qwen3SiglipForConditionalGeneration_moonvit(Qwen3SiglipPreTrainedModel, GenerationMixin):
    _tied_weights_keys = ["lm_head.weight"]
    config_class = Qwen3SiglipConfig
    _no_split_modules = ["Qwen3SiglipDecoderLayer", "MoonVitEncoderLayer"]
    ...
    def __init__(self, config):
        ...
        self.model = Qwen3SiglipModel(config)
        self.vocab_size = config.vocab_size
    ...
    def forward(
        ...
        **kwargs
        ...
        >>> import requests
        >>> from transformers import AutoProcessor, Qwen3SiglipForConditionalGeneration

        >>> model = Qwen3SiglipForConditionalGeneration.from_pretrained("Qwen/Qwen2.5-VL-7B-Instruct")
        ...
        return Qwen3SiglipCausalLMOutputWithPast(
            loss=loss,
            logits=logits,
...
class Qwen3SiglipForConditionalGeneration(Qwen3SiglipPreTrainedModel, GenerationMixin):
    _tied_weights_keys = ["lm_head.weight"]
    config_class = Qwen3SiglipConfig
    _no_split_modules = ["Qwen3SiglipDecoderLayer", "SiglipEncoderLayer"]
...
class Qwen3SiglipForConditionalGeneration_navit(Qwen3SiglipForConditionalGeneration):
    _tied_weights_keys = ["lm_head.weight"]
    config_class = Qwen3SiglipConfig
    _no_split_modules = ["Qwen3SiglipDecoderLayer", "SiglipEncoderLayer"]
