...
class Qwen3SiglipProcessorKwargs(ProcessingKwargs, total=False):
    videos_kwargs: Qwen3SiglipVideosProcessorKwargs
    _defaults = {
        "text_kwargs": {
            "padding": False,
        },
...
class Qwen3SiglipProcessor(ProcessorMixin):
    r"""
    Constructs a Qwen3-Siglip processor which wraps a Qwen3-Siglip image processor and a Qwen3 tokenizer into a single processor.
    [`Qwen3SiglipProcessor`] offers all the functionalities of [`Qwen3SiglipImageProcessor`] and [`Qwen3SiglipTokenizerFast`]. See the
    [`~Qwen3SiglipProcessor.__call__`] and [`~Qwen3SiglipProcessor.decode`] for more information.
    Args:
        image_processor ([`Qwen3SiglipImageProcessor`], *optional*):
    ...
    def __call__(
        ...
        **kwargs: Unpack[Qwen3SiglipProcessorKwargs],
    ) -> BatchFeature:
        """
