...
class SiglipVisionEmbeddings(nn.Module):
    ...
    def forward(
        ...
        has_learnable_position_embedding: Optional[bool] = True,
    ) -> torch.Tensor:
        if pixel_values.dim() == 4:
            ...
            if has_learnable_position_embedding is True:
...
class SiglipModel(SiglipPreTrainedModel):
    ...
    def get_text_features(
        ...
        # print(input_ids, attention_mask, position_ids, output_attentions, output_hidden_states)
        # exit(0)
