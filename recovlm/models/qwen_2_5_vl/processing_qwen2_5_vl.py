...
class Qwen2_5_VLProcessor_moonvit(ProcessorMixin):
    r"""
    Constructs a Qwen2.5-VL processor which wraps a Qwen2.5-VL image processor and a Qwen2 tokenizer into a single processor.
    [`Qwen2_5_VLProcessor`] offers all the functionalities of [`Qwen2VLImageProcessor`] and [`Qwen2TokenizerFast`]. See the
    [`~Qwen2_5_VLProcessor.__call__`] and [`~Qwen2_5_VLProcessor.decode`] for more information.
...
class Qwen2_5_VLProcessor_siglip(ProcessorMixin):
    r"""
    Constructs a Qwen2.5-VL processor which wraps a Qwen2.5-VL image processor and a Qwen2 tokenizer into a single processor.
    [`Qwen2_5_VLProcessor`] offers all the functionalities of [`Qwen2VLImageProcessor`] and [`Qwen2TokenizerFast`]. See the
    [`~Qwen2_5_VLProcessor.__call__`] and [`~Qwen2_5_VLProcessor.decode`] for more information.
...
def debug_processor():
    # /llm_reco/lingzhixin/recovlm_qw0510/recovlm/recovlm/models/qwen_2_5_vl/processing_qwen2_5_vl.py
    # PYTHONPATH=. python3 recovlm/models/qwen_2_5_vl/processing_qwen2_5_vl.py
    ...
    for processor in [
        Qwen2_5_VLProcessor.from_pretrained("/llm_reco_ssd/zhouyang12/models/Qwen2.5-VL-7B-Instruct/"),
        Qwen2_5_VLProcessor_siglip.from_pretrained("/llm_reco_ssd/zhouyang12/models/Qwen2.5-VL-7B-Instruct/"),
    ]:
        text = "<|vision_start|><|image_pad|><|vision_end|>图片有什么"
        messages = [
            {
                "role": "user",
                "content": [
                    {"type": "image", "image": generate_circle_image((500,500))},
                    {"type": "text", "text": text},
                ],
            }
        ]
