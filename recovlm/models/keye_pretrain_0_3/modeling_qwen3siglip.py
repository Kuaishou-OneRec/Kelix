...
class SiglipVisionTransformer(nn.Module):
    ...
    @replace_return_docstrings(output_type=BaseModelOutputWithPooling, config_class=Qwen3SiglipVisionConfig)
    def forward(
        self,
        pixel_values,
        output_attentions: Optional[bool] = None,
...
class Qwen3SiglipForConditionalGeneration_navit(Qwen3SiglipPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        super().__init__(config)
        Siglip_config = Qwen3SiglipConfig.from_pretrained('/llm_reco_ssd/zhouyang12/models/siglip2-so400m-patch16-naflex')
        print('Qwen3SiglipForConditionalGeneration_navit',config)
        print(config)
        print(Siglip_config)
