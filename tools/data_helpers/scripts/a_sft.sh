...
mpirun --allow-run-as-root -np $np \
        ...
        python3 /llm_reco/chuchenglong/R3/recovlm/tools/data_helpers/parquet_writer_worker.py /llm_reco/chuchenglong/R3/recovlm/tools/data_helpers/config/sft_convert.yaml