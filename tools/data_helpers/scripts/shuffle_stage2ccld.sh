...
mpirun --allow-run-as-root -np $np \
        ...
        --output viewfs://hadoop-lt-cluster/home/reco_wl/mpi/chuchenglong/pt/0421/stage2_ccl_v3_0425d \
        --input 	viewfs://hadoop-lt-cluster/home/reco_wl/mpi/luoxinchen/recovlm_dataset_original/caption/Capsfusion-V3@0.01 \
