...
mpirun --allow-run-as-root -np $np \
        ...
        python3 tools/data_helpers/converters/converter_vit.py --folder viewfs://hadoop-lt-cluster/home/reco_wl/mpi/luoxinchen/recovlm_dataset_stage1/coco_captions --postfix parquet --output viewfs://hadoop-lt-cluster/home/reco_wl/mpi/luoxinchen/recovlm_dataset_original/vit/coco_captions