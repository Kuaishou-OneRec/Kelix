...
mpirun --allow-run-as-root -np $np \
        ...
        python3 shuffle.py \
		--input_dir \
		viewfs://hadoop-lt-cluster/home/reco_wl/mpi/chuchenglong/TQA_QA \
		viewfs://hadoop-lt-cluster/home/reco_wl/mpi/chuchenglong/AI2D \
		viewfs://hadoop-lt-cluster/home/reco_wl/mpi/zangdunju/recovlm/stage3/0429 \
		--output_dir \
		viewfs://hadoop-lt-cluster/home/reco_wl/mpi/zangdunju/recovlm/stage3/0430/all_stage3
