...
def smart_resize(
    height: int, width: int, factor: int = 32, min_pixels: int = 64 * 64, max_pixels: int = 16 * 16 * 4096
):
...
class SiglipImageProcessor(BaseImageProcessor):
    ...
    Args:
        ...
        min_pixels (`int`, *optional*, defaults to `64 * 64`):
            The min pixels of the image to resize the image.
        max_pixels (`int`, *optional*, defaults to `32 * 32 * 1280`):
