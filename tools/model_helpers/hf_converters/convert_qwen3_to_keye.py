...
python3 /llm_reco/lingzhixin/recovlm_qw0510/recovlm/tools/model_helpers/hf_converters/convert_qwen3_to_keye.py --delete_mlp 0 --model_dir /llm_reco_ssd/zhouyang12/models/Keye-8B-demo_hf_vit_rope_slowfast_0625_fast_navit/ --vit_model_path /llm_reco_ssd/zhouyang12/models/Keye-8B-demo_hf_vit_rope_slowfast_0625_fast_navit/ --new_model_dir /llm_reco_ssd/zhouyang12/models/Keye-8B-demo_hf_vit_rope_slowfast_0625_fast_navit_split


python3 /llm_reco/lingzhixin/recovlm_qw0510/recovlm/tools/model_helpers/hf_converters/convert_qwen3_to_keye.py --delete_mlp 0 --model_dir /mmu_mllm_hdd_2/lingzhixin/models/Keye-8B-demo_hf_vit_rope_slowfast_0703_patch14_qwen3 --vit_model_path /mmu_mllm_hdd_2/lingzhixin/models/Keye-8B-demo_hf_vit_rope_slowfast_0703_patch14_qwen3 --new_model_dir /mmu_mllm_hdd_2/lingzhixin/models/Keye-8B-demo_hf_vit_rope_slowfast_0703_patch14_qwen3_split

/mmu_mllm_hdd_2/zhouyang12/output2/Keye/0.8.0/ViT/400m/0.0.2/global_step18900/vision_model.pth
python3 /llm_reco/lingzhixin/recovlm_qw0510/recovlm/tools/model_helpers/hf_converters/convert_qwen3_to_keye.py --delete_mlp 0 --model_dir /llm_reco_ssd/zhouyang12/models/Keye-8B-demo_hf_vit_rope --vit_model_path /mmu_mllm_hdd_2/zhouyang12/output2/Keye/0.8.0/ViT/400m/0.0.2/global_step18900/vision_model.pth --new_model_dir /mmu_mllm_hdd_2/lingzhixin/models/Keye-8B-demo_hf_vit_rope_nopos_0714_v1/ > tmp1.out 2>&1 &

# /mmu_mllm_hdd_2/zhouyang12/output2/Keye/0.8.0/ViT/400qknorm/1.0.1/global_step22500/vision_model.pth
python3 /llm_reco/lingzhixin/recovlm_qw0510/recovlm/tools/model_helpers/hf_converters/convert_qwen3_to_keye.py --delete_mlp 0 --model_dir /llm_reco_ssd/zhouyang12/models/Keye-8B-demo_hf_vit_rope --vit_model_path /mmu_mllm_hdd_2/zhouyang12/output2/Keye/0.8.0/ViT/400qknorm/1.0.1/global_step22500/vision_model.pth --new_model_dir /mmu_mllm_hdd_2/lingzhixin/models/Keye-8B-demo_hf_vit_rope_nopos_qknorm_0714_v2/ > tmp2.out 2>&1 &
...
def main():
  ...
  for key in llm_sd.keys():
    if key.startswith("visual."): 
      print(f"skip key {key}, keep vit_sd to vllm_sd")
      continue
    print(f"key {key}, from llm to vllm")
