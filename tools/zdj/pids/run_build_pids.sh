...
mpirun --allow-run-as-root -np $np \
        ...
        python3 build_pids_mpi.py \
        --folder viewfs://hadoop-lt-cluster/home/reco_kaiworks/dw/reco_kaiworks.db/lxc_hot_photo_list_daily \
        --output /llm_reco/zangdunju/dataset/kwai_photo/infer \
        --start_date=20250317 \
        --end_date=20250331 \
        --postfix="000000" \
        --ratio 1.0 \
