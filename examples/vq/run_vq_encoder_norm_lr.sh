...
MODEL_DIR=/llm_reco_ssd/zhouyang12/models/KeyeImageTokenizer_init_encoder_norm
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output/Keye/vq_test/8B_encoder_norm_lr
