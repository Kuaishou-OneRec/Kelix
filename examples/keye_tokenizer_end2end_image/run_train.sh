...
MODEL_DIR=/llm_reco_ssd/zhouyang12/models/muse/keye_tokenizer_end2end_image

OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output/MuseV2/keye_tok_e2e/test
...
# 注意修改实验内容备注
comment="keye_tokenizer_end2end_image_train"
