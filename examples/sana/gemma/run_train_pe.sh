...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output/MuseV2/sana/t2i_pe
...
# 注意修改实验内容备注
comment="sana_t2i_use_position_embedding"
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "python3 recipes/train_dit.py \
                ...
                --logging-per-step 5 \
                --clip-range 0.1 \
                --model-config-overrides use_pe=true pe_interpolation=1.0 \
                --use-chi \
                --fp32-weight \
                --seed 19260817 \
