...
DATASET_CONFIG="examples/sana/ar_dit/exp42_eval_different_prompt/exp42_ar_dit_324tokens_1e-4_cond_special_prompt5.json"
...
log_file=${DCP_CKPT_DIR}/auto_monitor5.log
