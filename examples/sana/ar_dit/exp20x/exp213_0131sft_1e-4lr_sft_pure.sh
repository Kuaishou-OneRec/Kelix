...
MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp20x/exp208_pretrain_1e-4lr_sft_pure_step1w_102/global_step9500/converted/
MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp17x/exp172_0131sft_ar_ditpt/global_step80000/converted/
# # 等待MODEL_DIR存在
# # 循环等待，直到目录存在
