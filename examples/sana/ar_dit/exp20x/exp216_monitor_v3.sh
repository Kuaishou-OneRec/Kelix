...
top_sft_dir=/mmu_mllm_hdd_2/lingzhixin/output/Keye/vqar_11.9.1/v9.15_stage3_0.95_256u_from_v86_fix4
step=15000
...
DCP_CKPT_DIR="/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp20x/exp216_pretrain_1e-4lr_sft_pure_step15k/"

DATASET_CONFIG="examples/sana/ar_dit/exp42_eval_different_prompt/exp42_ar_dit_324tokens_1e-4_cond_special_prompt4.json"
MAX_CONDITION_LENGTH=720
INFERENCE_SCRIPT="examples/sana/ar_dit/inference/mpi_infer_custom_cond_spe_v2.sh"
