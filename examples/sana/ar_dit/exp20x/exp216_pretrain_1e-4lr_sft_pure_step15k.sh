...
MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp20x/exp215_pretrain_1e-4lr_sft_pure_step15k/./global_step2500/converted/
# # 等待MODEL_DIR存在
# # 循环等待，直到目录存在
