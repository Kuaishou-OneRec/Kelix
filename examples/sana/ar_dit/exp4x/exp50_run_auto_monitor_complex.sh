...
DCP_CKPT_DIR="/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp4x/exp50_ar_dit_324tokens_resize_and_cc_assistant_1e-4.json"
DATASET_CONFIG="examples/sana/ar_dit/exp4x/exp50_ar_dit_324tokens_resize_and_cc_assistant.json"
