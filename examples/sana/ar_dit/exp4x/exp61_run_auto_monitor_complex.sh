...
DCP_CKPT_DIR="/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp4x/exp61_ori_ds_rope"
DCP_CKPT_DIR="/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp4x/exp61_new_ds_rope"
DATASET_CONFIG="examples/sana/ar_dit/exp4x/exp41_ar_dit_324tokens_1e-4_cond_special.json"
MAX_CONDITION_LENGTH=720
INFERENCE_SCRIPT="examples/sana/ar_dit/inference/mpi_infer_custom_cond_spe_rope.sh"
MODEL_CONFIG_OVERRIDES="model_max_length=720 use_cross_attn_rope=True use_position_scale=True"
