...
VISUAL_PARQUET_PATH=/mmu_mllm_hdd_2/lingzhixin/recovlm_data/muse_v2/vis/vis_data0110a.parquet
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "python3 recipes/sana/train_sana_ar_dit.py \
                ...
                --dataset-config examples/sana/ar_dit/exp4x/exp43_ar_dit_324tokens_1e-4_cond_special.json \
