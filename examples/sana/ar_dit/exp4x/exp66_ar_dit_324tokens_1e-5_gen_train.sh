...
# /mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp4x/exp42_ar_dit_324tokens_1e-4_cond_special/global_step52000/converted/
MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp4x/exp42_ar_dit_324tokens_1e-4_cond_special/global_step52000/converted/
...
nohup mpirun --allow-run-as-root \
        ...
        -x https_proxy=\
        with_nccl_local_env \
        bash -c "python3 recipes/sana/train_sana_ar_dit_by_gen.py \
