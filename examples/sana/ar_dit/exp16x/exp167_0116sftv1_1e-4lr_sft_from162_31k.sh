...
MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp16x/exp165_0116sftv1_1e-4lr_pt_res162_fix/global_step44000/converted
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "python3 recipes/sana/train_sana_ar_dit.py \
                ...
                --dataset-config examples/sana/ar_dit/exp16x/exp164_0116sftv1_1e-4lr_sft_from162_31k.json \
