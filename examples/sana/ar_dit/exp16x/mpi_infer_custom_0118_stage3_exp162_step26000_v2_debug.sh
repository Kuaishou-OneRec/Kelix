...
DATASET_CONFIG="${DATASET_CONFIG:-examples/sana/ar_dit/exp16x/exp163_0116sftv1_1e-4lr_directly_sft_debug.json}"
...
DCP_CKPT_DIR=/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp16x/exp162_0116sftv1_1e-4lr_pt_fix/
DCP_TAG=global_step26000
