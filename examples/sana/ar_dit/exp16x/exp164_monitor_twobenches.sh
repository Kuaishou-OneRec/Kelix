...
DCP_CKPT_DIR="/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp16x/exp164_0116sftv1_1e-4lr_sft_from162_31k/"
DATASET_CONFIG="examples/sana/ar_dit/exp16x/exp162_0116sftv1_1e-4lr_pt_fix.json"
MAX_CONDITION_LENGTH=720
INFERENCE_SCRIPT="examples/sana/ar_dit/inference/mpi_infer_custom_cond_spe_twobenches.sh"
...
nohup python3 -u examples/keye_ar/auto_infer_eval.py \
    ...
    --benchnames "GenEval,DPGBench" \
    --ulmeval-configs "GenEval=config/blip3o_sft_step800.json,DPGBench=config/dpg_blip3o_sft.json" \
    > ${log_file} &
