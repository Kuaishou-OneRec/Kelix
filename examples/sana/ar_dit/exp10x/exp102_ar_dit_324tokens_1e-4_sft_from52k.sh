...
MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp4x/exp42_ar_dit_324tokens_1e-4_cond_special/global_step70000/converted/
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "python3 recipes/sana/train_sana_ar_dit.py \
                ...
                --dataset-config examples/sana/ar_dit/exp10x/exp100_ar_dit_324tokens_1e-4_sft_from52k.json \
