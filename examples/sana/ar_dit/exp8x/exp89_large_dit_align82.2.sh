...
MODEL_CONFIG=/mmu_mllm_hdd_2/yangyiping/models/SANA1.5_4.8B_1024px_diffusers_muse_converted-0105-advanced-conf/config.json
VAE_DIR=/mmu_mllm_hdd_2/yangyiping/models/SANA1.5_4.8B_1024px_diffusers/vae/
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "python3 recipes/sana/train_sana_ar_dit.py \
                ...
                --dataset-config examples/sana/ar_dit/exp8x/exp82.1_324_token.json \
                --resolution-budgets "1024:13" \
                --learning-rate 2e-4 \
                --min-lr 1e-4 \
