...
KEYE_AR_DIR=/mmu_mllm_hdd_2/zhouyang12/output/Keye/vqar_11.9.1/v9.2_stage3_0.81_128u/step23500/step23500/muse_converted

# Override parameters (if needed)
DCP_CKPT_DIR="/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp13x/exp134_2e-5lr_23500/"
...
rm -rf ${DCP_CKPT_DIR}/token_cache
