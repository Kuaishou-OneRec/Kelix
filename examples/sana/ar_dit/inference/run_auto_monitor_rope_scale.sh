...
DCP_CKPT_DIR="/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/sana/ar_dit/exp26_ar_dit_324tokens_1e-4_reproduce_with_pos/"
DCP_CKPT_DIR="/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/sana/ar_dit/exp27_ar_dit_324tokens_1e-4_reproduce_with_pos_scale/"
...
DATASET_CONFIG="examples/sana/ar_dit/inference/run_ar_dit_lzx_4096_v2_1024im_multiscale_inf.json"
INFERENCE_SCRIPT="examples/sana/ar_dit/inference/mpi_infer_custom_rope_v2.sh"
