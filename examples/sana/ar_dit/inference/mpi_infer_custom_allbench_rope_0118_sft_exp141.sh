...
MAX_CONDITION_LENGTH="${MAX_CONDITION_LENGTH:-658}"
IMAGE_SIZE="${IMAGE_SIZE:-1024}"
SEED="${SEED:-42}"
INITIALIZE_DIST="${INITIALIZE_DIST:-true}"  # initialize a local single-process dist group
MODEL_CONFIG_OVERRIDES="${MODEL_CONFIG_OVERRIDES:-model_max_length=658}"
...
DCP_CKPT_DIR="${DCP_CKPT_DIR:-/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp13x/exp131_1e-4lr_23500}"
DCP_TAG="${DCP_TAG:-global_step9500}"
