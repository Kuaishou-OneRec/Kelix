...
DCP_CKPT_DIR="/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp15x/exp155_0116sftv1_1e-4lr_from152_sft_from9k/"
...
if [ ! -e $DCP_CKPT_DIR/token_cache ]; then
    ln -s /mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp15x/exp154_0116sftv1_1e-4lr_from152_sft_from6k/token_cache ${DCP_CKPT_DIR}
fi
