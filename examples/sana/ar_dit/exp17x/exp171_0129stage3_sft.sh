...
PYTHONPATH=. python3 examples/keye_ar/convert_hf_checkpoint.py \
        --hf-checkpoint-path /mmu_mllm_hdd_2/zhouyang12/output/Keye/vqar_11.9.1/v9.15_stage3_0.95_256u/step47000/global_step47000/converted \
        --output-dir /mmu_mllm_hdd_2/zhouyang12/output/Keye/vqar_11.9.1/v9.15_stage3_0.95_256u/step47000/global_step47000/muse_converted
...
KEYE_AR_DIR=/mmu_mllm_hdd_2/zhouyang12/output/Keye/vqar_11.9.1/v9.15_stage3_0.95_256u/step47000/global_step47000/muse_converted
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "python3 recipes/sana/train_sana_ar_dit.py \
                ...
                --dataset-config examples/sana/ar_dit/exp17x/exp171_0129stage3_sft.json \
