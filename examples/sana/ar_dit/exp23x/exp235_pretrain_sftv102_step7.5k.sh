...
# /mmu_mllm_hdd_2/lingzhixin/output/Keye/vqar_11.9.1/sft/v105_sft_1.18.1_24u_from_v86fix5/step7000/global_step7000
# /mmu_mllm_hdd_2/lingzhixin/output/Keye/vqar_11.9.3/sft/v102_sft_from9.15/step7500/global_step7500/muse_converted/
top_sft_dir=/mmu_mllm_hdd_2/lingzhixin/output/Keye/vqar_11.9.3/sft/v102_sft_from9.15/
step=7500
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "python3 recipes/sana/train_sana_ar_dit.py \
                ...
                --dataset-config examples/sana/ar_dit/exp18x/exp182_0116sftv1_1e-4lr_pt_fix.json \
                --resolution-budgets "1024:20" \
                --learning-rate 2e-4 \
                --min-lr 1e-4 \
                --num-decay-steps 3000 \
                --weight-decay 0.0 \
                --image-size 1024 \
                --beta1 0.9 \
                --beta2 0.95 \
