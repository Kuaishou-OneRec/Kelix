...
DCP_CKPT_DIR="/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp23x/exp234_0131sft_1e-4lr_sft_pure/"
ln -s /mmu_mllm_hdd_2/lingzhixin/output/MuseV2/ar_dit/exp23x/exp233_pretrain_1e-4lr_sft_pure_step1w_102/token_cache ${DCP_CKPT_DIR}
