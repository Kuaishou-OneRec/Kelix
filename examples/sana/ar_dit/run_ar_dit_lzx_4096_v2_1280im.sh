...
OUTPUT_DIR=/mmu_mllm_hdd_2/lingzhixin/output/MuseV2/sana/run_ar_dit_lzx_4096_v2_1280im
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "python3 recipes/sana/train_sana_ar_dit.py \
                ...
                --dataset-config examples/sana/ar_dit/run_ar_dit_lzx_4096_v2_1280im.json \
                --learning-rate 1e-4 \
                --min-lr 1e-7 \
                --weight-decay 0.0 \
                --image-size 1280 \
