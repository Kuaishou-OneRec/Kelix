...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output/MuseV2/sana/t2i_ae_up_1024px_s1.0_cond100
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "python3 recipes/train_sana_ae.py \
                ...
                --image-size 1024 \
                --beta1 0.9 \
                --model-config-overrides caption_channels=1024 model_max_length=100 y_norm_scale_factor=1 \
                --beta2 0.999 \
                --batch-size 16 \
