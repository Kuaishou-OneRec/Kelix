...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output/MuseV2/sana/t2i_ae_up_debug
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "python3 recipes/train_sana_ae.py \
                ...
                --allow-random-init-params "y_embedder.y_proj.fc1.weight,y_embedder.y_embedding,norm_cross" \
