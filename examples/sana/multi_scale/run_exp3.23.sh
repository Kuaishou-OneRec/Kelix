...
MODEL_DIR=/mmu_mllm_hdd_2/zhouyang12/output/MuseV2/sana_v2/multi_scale/exp3.22/global_step20000/converted
...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output/MuseV2/sana_v2/multi_scale/exp3.23
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "python3 recipes/sana/train_auto_encoder.py \
                ...
                --resolution-start-weights "1.0" \
                --resolution-end-weights "1.0" \
