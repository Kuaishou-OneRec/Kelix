...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output/MuseV2/sana_v2/multi_scale/exp2.6
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "python3 recipes/train_sana_ae.py \
                ...
                --image-size 512 \
                --beta1 0.9 \
                --model-config-overrides caption_channels=1024 model_max_length=324 y_norm_scale_factor=0.1 \
                --multi-scale \
                --resolution-budgets "512:32,768:16,1024:8" \
                --resolution-start-weights "0.5,0.3,0.2" \
                --resolution-end-weights "0.2,0.3,0.5" \
