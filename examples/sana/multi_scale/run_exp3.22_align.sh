...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output/MuseV2/sana_v2/multi_scale/exp3.22_align
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "python3 recipes/sana/train_auto_encoder.py \
                ...
                --batch-size 32 \
                --beta1 0.9 \
                --model-config-overrides caption_channels=1024 model_max_length=2560 y_norm_scale_factor=1 use_cross_attn_rope=True cross_attn_x_norm=True \
                --multi-scale \
                --fusion-type mean \
                --beta2 0.999 \
