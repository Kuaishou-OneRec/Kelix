...
MODEL_DIR=/mmu_mllm_hdd_2/zhouyang12/output/MuseV2/sana_v2/multi_scale/exp3.22/global_step100000/converted/
...
# PYTHONPATH=. python3 muse/tools/dcp2torch.py /mmu_mllm_hdd_2/zhouyang12/output/MuseV2/sana_v2/multi_scale/exp3.22/ --source-dir /mmu_mllm_hdd_2/zhouyang12/output/MuseV2/sana_v2/multi_scale/exp3.22/global_step51000/converted/ --tag global_step100000

# 修复 exp3.11 的 bug，将 token embeddings 的h,w除以2，因为token embeddings是2x2 patch合并的
mv /mmu_mllm_hdd_2/zhouyang12/output/MuseV2/sana_v2/multi_scale/exp3.28 /mmu_mllm_hdd_2/zhouyang12/output/MuseV2/sana_v2/multi_scale/exp3.28_tmp
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output/MuseV2/sana_v2/multi_scale/exp3.28
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "python3 recipes/sana/train_auto_encoder.py \
                ...
                --dataset-config examples/sana/datasets/mix_1024.json \
