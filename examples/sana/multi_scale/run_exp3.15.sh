...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output/MuseV2/sana_v2/multi_scale/exp3.15
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "python3 recipes/train_sana_ae.py \
                ...
                --image-size 1024 \
                --beta1 0.9 \
                --model-config-overrides caption_channels=1024 model_max_length=1280 y_norm_scale_factor=1 use_cross_attn_rope=True cross_attn_x_norm=True use_position_scale=True \
                --beta2 0.999 \
                --batch-size 16 \
