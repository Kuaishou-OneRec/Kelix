...
OUTPUT_DIR=/llm_reco_ssd/luoxinchen/output3/RecoVLM-Base/0.3.0/cmt
...
nohup deepspeed --hostfile=/etc/mpi/hostfile_seq --num_nodes=$nnode \
    ...
    --dataset_config /llm_reco/maosiyang/pt/recovlm/examples/vlm/configs/msy_stage1_cmt_7b.json \
