...
git add --all
git commit -m "email=$email,time=$(date +"%Y%m%d %H:%M:%S"),script=$0,node=$nnode,comment=$comment,output=$OUTPUT_DIRresume"
...
nohup mpirun --allow-run-as-root \
		...
		--model_class KeyeForConditionalGeneration_vitrope_slowfast_tatok \
                --allow_random_init_params 'mlp_AR.pre_norm.weightmlp_AR.pre_norm.bias,mlp_AR.linear_1.weight,mlp_AR.linear_1.bias,mlp_AR.linear_2.weight,mlp_AR.linear_2.bias,visual_fast.vision_model.embeddings.packing_position_embedding.weightfast_mlp_AR.pre_norm.weightfast_mlp_AR.pre_norm.biasfast_mlp_AR.linear_1.weightfast_mlp_AR.linear_1.biasfast_mlp_AR.linear_2.weightfast_mlp_AR.linear_2.biasvisual.vision_model.head.probevisual.vision_model.head.attention.in_proj_weightvisual.vision_model.head.attention.in_proj_biasvisual.vision_model.head.attention.out_proj.weightvisual.vision_model.head.attention.out_proj.biasvisual.vision_model.head.layernorm.weightvisual.vision_model.head.layernorm.biasvisual.vision_model.head.mlp.fc1.weightvisual.vision_model.head.mlp.fc1.biasvisual.vision_model.head.mlp.fc2.weightvisual.vision_model.head.mlp.fc2.biasvision_tower.vision_tower.encode_task_layer.0.weightvision_tower.vision_tower.encode_task_layer.0.biasvision_tower.vision_tower.decode_task_layer.0.weightvision_tower.vision_tower.decode_task_layer.0.biasvision_tower.vision_tower.decode_task_layer.2.weightvision_tower.vision_tower.decode_task_layer.2.biasvision_tower.vision_tower.bottleneck.in_linear.weightvision_tower.vision_tower.bottleneck.in_linear.biasvision_tower.vision_tower.bottleneck.out_linear.weightvision_tower.vision_tower.bottleneck.out_linear.biasvision_tower.vision_tower.bottleneck.regularizer.embedding.weightvision_tower.vision_tower.bottleneck.regularizer.embedding_proj.weightvision_tower.vision_tower.bottleneck.regularizer.embedding_proj.biasvision_tower.vision_tower.scale_layer.shiftvision_tower.vision_tower.scale_layer.scale,' \
