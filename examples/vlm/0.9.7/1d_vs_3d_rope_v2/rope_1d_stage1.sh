...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.9.7/Stage1/8b/1d_vs_3d_rope_v2/rope1d_0814
...
nohup mpirun --allow-run-as-root \
		...
		--dataset_config examples/vlm/0.9.7/1d_vs_3d_rope_v2/exp_0.5.11_stage1.json \
