...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output/Keye/Stage3_data_0.3.2/0.8.0/221/2b/
...
nohup mpirun --allow-run-as-root \
	...
	-x TOKENIZERS_PARALLELISM=false \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.8.0/qwen3navit_2B_stage3.221.json \
		...
		--monitor_image_tokens \
                ...
                --resume_from /mmu_mllm_hdd_2/zhouyang12/output/Keye/Stage2_0.4.2_resume10k/0.8.0/2b/step2000 \
