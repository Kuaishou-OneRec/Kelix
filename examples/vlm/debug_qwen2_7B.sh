...
OUTPUT_DIR=/llm_reco/lingzhixin/output3/debug/0.0.2/debug_qwen2_7B
...
nohup mpirun --allow-run-as-root -np $np \
        ...
        python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/configs/lzx_stage1_mix_72b_0_4_5.json \
                --model_processor Qwen2VLProcessor \
