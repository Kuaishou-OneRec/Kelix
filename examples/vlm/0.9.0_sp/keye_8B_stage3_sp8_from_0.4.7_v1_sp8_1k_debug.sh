...
OUTPUT_DIR=/mmu_mllm_hdd_2/lingzhixin/output1/Keye/vlm/0.9.0_sp_debug/8b/v1_sp8_1k/ 
...
nohup mpirun --allow-run-as-root \
	...
	-x TOKENIZERS_PARALLELISM=false \
		...
		--dataset_config examples/vlm/0.9.0_sp/keye_8B_stage3_sp8_from_0.4.7_v1_sp8_1k.json \
