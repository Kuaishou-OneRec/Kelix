...
OUTPUT_DIR=/mmu_mllm_hdd_2/lingzhixin/output/Keye/exp_saveload0606/0.9.1load3/2b
...
# 注意修改实验内容备注
comment="version:0.9.1;model_size:8B"
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.9.0_8B_stage2/debug/keye_stage2_bal.json \
                ...
                --kml_task_id $KML_TASK_ID \
		                --resume_from /mmu_mllm_hdd_2/lingzhixin/output/Keye/exp_saveload0606/0.9.1save_bal3/2b/step8 \
                --resume_from_tag global_step8 \
		--resume_dataloader \
