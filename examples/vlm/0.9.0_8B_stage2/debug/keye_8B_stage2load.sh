...
OUTPUT_DIR=/mmu_mllm_hdd_2/lingzhixin/output/Keye/exp_saveload0606/0.9.1load/2b
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.9.0_8B_stage2/debug/keye_stage2.json \
                ...
                --resume_from /mmu_mllm_hdd_2/lingzhixin/output/Keye/exp_saveload0606/0.9.1save/2b/step3000 \
