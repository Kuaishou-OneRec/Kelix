...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.9.3/Stage3/8b/0804_debug_sfv2/sp8_debug
...
nohup mpirun --allow-run-as-root \
		...
		--dataset_config examples/vlm/0.9.3/0804_debug_sfv2/sp8_debug.json \
