...
OUTPUT_DIR=/mmu_mllm_hdd_2/lingzhixin/output1/Keye/0.9.1/Stage3_SlowFast/8b/slowfast_0723_2
...
nohup mpirun --allow-run-as-root \
		...
		--dataset_config /llm_reco/lingzhixin/recovlm_qw0510/recovlm/examples/vlm/0.9.3/0714/keye_stage3_video_1sample_2.json \
