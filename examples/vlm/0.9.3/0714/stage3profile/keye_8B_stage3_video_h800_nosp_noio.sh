...
OUTPUT_DIR=/mmu_mllm_hdd_2/lingzhixin/output1/Keye/0.9.3/Stage3profile/8b/slowfast_h800_noio_npsp2
...
nohup mpirun --allow-run-as-root \
		...
		--dataset_config examples/vlm/0.9.3/0714/stage3profile/keye_stage3_video_nosp.json \
