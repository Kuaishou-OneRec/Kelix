...
OUTPUT_DIR=/mmu_mllm_hdd_2/lingzhixin/output1/Keye/0.9.1/Stage3_SlowFast/8b/slowfast_0714_keyframe_lzx_sp2
...
nohup mpirun --allow-run-as-root \
		...
		--dataset_config /llm_reco/nasen/wq-kai-megatron/keye_stage3_video.json \
