...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.9.1/Stage3_SlowFast/8b/slowfast_0714_keyframe_lzx_learning_position_debug
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.9.3/0714/keye_0.9.3_stage3_0.4.8_5e-5_slowfast_balance_false_0714_keyframe_lzx_learningrate.json \
