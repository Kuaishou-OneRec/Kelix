...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.9.3/Stage2/8b/slowfast-0721-0717
...
nohup mpirun --allow-run-as-root \
		...
		--resume_from /mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.9.3/Stage1/8b/slowfast-0714-v2/step12000 \
