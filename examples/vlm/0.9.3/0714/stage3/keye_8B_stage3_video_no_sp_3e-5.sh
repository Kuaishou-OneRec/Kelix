...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.9.3/Stage3/8b/slowfast-0718-sp1-3e-5
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.9.3/0714/stage3/keye_stage3_video_no_sp.json \
                ...
                --max_length 15000 \
                --learning_rate 3e-5 \
                --vision_learning_rate 3e-6 \
                --min_lr 0 \
                --weight_decay 0.1 \
                --lr_scheduler_type cosine \
                --num_warmup_steps 1000 \
                --num_training_steps 19000 \
