...
OUTPUT_DIR=/mmu_mllm_hdd_2/lingzhixin/output1/Keye/0.9.1/Stage3_SlowFast/8b/slowfast_0723_debug_053_2
...
nohup mpirun --allow-run-as-root \
		...
		--dataset_config /mmu_mllm_hdd_2/lingzhixin/recovlm_data/data/keye_stage3_video_0730_sp1_15k_2.json \
