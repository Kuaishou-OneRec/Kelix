...
MODEL_DIR=/mmu_mllm_hdd_2/zhouyang12/models/Keye-8B-demo_hf_vit_rope_slowfast_0714_sp8
#OUTPUT_DIR=/llm_reco/maosiyang/train_out/0.9.1/keye_2B_stage1/
OUTPUT_DIR=/mmu_mllm_hdd_2/lingzhixin/output1/Keye/0.9.1/Stage3_SlowFast/8b/slowfast_0723_debug4
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.9.3/Stage3/8b/debug/sp8-from27000-400H_0801_reproduce
...
nohup mpirun --allow-run-as-root \
		...
		--dataset_config /llm_reco_ssd/caojiangxia/vllm/recovlm/examples/vlm/0.9.3/0714/stage3/keye_stage3_video_sp8_0.5.12.json \
