...
OUTPUT_DIR=/llm_reco/lingzhixin/output/Keye/Stage2_0.4.4/0.8.0debug/8b/
...
nohup mpirun --allow-run-as-root \
	...
	bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/qwen3navit/qwen3navit_8B_stage2_0404_v2.json \
                ...
                --resume_from /mmu_mllm_hdd_2/zhouyang12/output/Keye/Stage2_0.4.3/0.8.0/8b/step2000/ \
