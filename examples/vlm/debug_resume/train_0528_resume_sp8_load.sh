...
OUTPUT_DIR=/mmu_mllm_hdd_2/lingzhixin/output/keye_debug_resume_sp8/load/8B/
...
nohup mpirun --allow-run-as-root \
	...
	-x TOKENIZERS_PARALLELISM=false \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/debug_resume/train_0528_resume.json \
		...
		--resume_from /mmu_mllm_hdd_2/lingzhixin/output/keye_debug_resume_sp8/save/8B/step10 \
