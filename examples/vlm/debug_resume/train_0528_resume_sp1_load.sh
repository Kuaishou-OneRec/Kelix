...
OUTPUT_DIR=/mmu_mllm_hdd_2/lingzhixin/output/keye_debug_resume_sp1/load/8B/
...
nohup mpirun --allow-run-as-root \
	...
	-x TOKENIZERS_PARALLELISM=false \
		...
		--resume_from /mmu_mllm_hdd_2/lingzhixin/output/keye_debug_resume_sp1/save/8B/step20 \
