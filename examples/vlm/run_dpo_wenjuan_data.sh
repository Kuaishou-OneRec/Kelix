...
OUTPUT_DIR=/llm_reco_ssd/huqigen/model_output/RecoVLM/Qwen2-VL-7B-dpo-wenjuan/0.0.0.1
...
nohup deepspeed --hostfile=/etc/mpi/hostfile_seq --num_nodes=$nnode \
    ...
    --dataset_config ./examples/vlm/configs/dpo_wenjuan_0210_10w_test.json \
