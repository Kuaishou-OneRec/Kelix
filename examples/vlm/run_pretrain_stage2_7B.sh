...
OUTPUT_DIR=/llm_reco_ssd/luoxinchen/output/RecoVLM/Qwen2-VL-7B-stage2/0.0.22
...
# 注意修改实验内容备注
comment="stage2，打开LLM训练，使用目前全部数据集，max_len=8192，compile=True，增加数据集，add padding，add eos token, add image pad"
