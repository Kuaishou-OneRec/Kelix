...
OUTPUT_DIR=/llm_reco_ssd/luoxinchen/output/RecoVLM/Qwen2-VL-7B-stage2/0.0.16.1
...
# 注意修改实验内容备注
comment="stage2，打开LLM训练，使用目前全部数据集，增加gradacc，mexlegth=8192，增加shuffle逻辑，增加数据集监控，lr恢复qwen，resume load ckpt, 关闭ACC"
