...
OUTPUT_DIR=/llm_reco_ssd/luoxinchen/output/RecoVLM/Qwen2-VL-7B-stage2/0.0.19
...
# 注意修改实验内容备注
comment="stage2，打开LLM训练，使用目前全部数据集，增加gradacc，mexlegth=8192，增加shuffle逻辑，增加数据集监控，lr恢复qwen，resume load ckpt, 打开ACC，stop step, 使用 zero1 避免 overlap comm bug"
