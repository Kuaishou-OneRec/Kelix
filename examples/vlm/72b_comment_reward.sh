...
OUTPUT_DIR=/llm_reco_ssd/zangdunju/output2/RecoVLM/Qwen2-VL-72B-RL/reward_model/0.0.0.1_token
...
# 注意修改实验内容备注
comment="sft 0.0.0.1: stg2 is 0.0.0.1 sample reward model 72b"
