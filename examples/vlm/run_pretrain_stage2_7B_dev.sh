...
OUTPUT_DIR=/llm_reco_ssd/luoxinchen/output2/RecoVLM/Qwen2-VL-7B-stage2/0.0.33.overfitting
...
# 注意修改实验内容备注
comment="stage2，直接从stg1初始化，全部ocr数据，增大学习率, vit 使用layer decay， 修复weight decay, overfitting"
...
nohup deepspeed --hostfile=/etc/mpi/hostfile_seq --num_nodes=$nnode \
    ...
    --dataset_config examples/vlm/configs/stage2_parquet_ocr_overfitting.json \
