...
OUTPUT_DIR=/llm_reco_ssd/zhangzixing/output2/RecoVLM-dev/Qwen2-VL-7B-stage2/0.0.25.4-spec_conf
...
nohup deepspeed --hostfile=/etc/mpi/hostfile_seq --num_nodes=$nnode \
    ...
    --dataset_config examples/vlm/configs/stage2_parquet_nointerleave_ds_conf.json \
