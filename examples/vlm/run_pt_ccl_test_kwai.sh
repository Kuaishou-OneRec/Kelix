...
OUTPUT_DIR=/llm_reco_ssd/luoxincheche/output3/chuchenglong/sft_1.0.0.0/sft_v0.2_test
...
nohup deepspeed --hostfile=/etc/mpi/hostfile_seq --num_nodes=$nnode \
    ...
    --dataset_config /llm_reco/chuchenglong/R3/recovlm/examples/vlm/configs/stage2_parquet_ocrall_0207_1epoch.json\
