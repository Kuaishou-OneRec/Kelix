...
MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/models/Keye-32B-vit0.8.1_0606/
# OUTPUT_DIR=/mmu_mllm_hdd_2/linghixin/output/examples/vlm/debug_32B/
OUTPUT_DIR=/mmu_mllm_hdd_2/lingzhixin/output/Keye/32b/Stage3/0.3.6/v15_res1k 
...
nohup mpirun --allow-run-as-root \
	...
	-x TOKENIZERS_PARALLELISM=false \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.8.4/keye_32B_stage3_v13.json  \
		...
		--reshard_after_forward \
                ...
                --resume_from /mmu_mllm_hdd_2/lingzhixin/output/Keye/32b/Stage3/0.3.6/v15/step1000/ \
