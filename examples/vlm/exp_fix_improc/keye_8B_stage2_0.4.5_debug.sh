...
OUTPUT_DIR=/mmu_mllm_hdd_2//output/Keye/0.8.3/stage2_0.4.5/8b
OUTPUT_DIR=/llm_reco/lingzhixin/output/exp_fix_improc/keye_8B_stage2_0.4.5_debug/0.8.2/2b
...
nohup mpirun --allow-run-as-root \
	...
	-x TOKENIZERS_PARALLELISM=false \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/exp_fix_improc/keye_8B_stage2_0.4.5_debug.json \
		...
		--monitor_image_tokens \
                ...
                --resume_from /mmu_mllm_hdd_2/zhouyang12/output/Keye/0.8.3/stage1_0.3.3/8b/step26000 \
		--resume_from_tag global_step26000 \
