...
OUTPUT_DIR=/llm_reco/lingzhixin/exp_outputs/throughput0507/qwen_stage2_256/0.0.3/
...
nohup mpirun --allow-run-as-root \
        ...
        python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/throughput0507/2b_v0_6_0_qwen_stage2_256.json \
