...
# MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/models/Keye-32B-scratch_0606
...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.8.6/Stage3/8b/v5/ 
...
nohup mpirun --allow-run-as-root \
	...
	-x TOKENIZERS_PARALLELISM=false \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
         	...
         	--resume_from /mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.8.6/Stage1/8b/v3/step6800 \
