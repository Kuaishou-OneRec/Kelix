...
sed 's/=1/=8/g' /etc/mpi/hostfile | head -199 > /etc/mpi/hostfile_seq

# MODEL_DIR=/llm_reco_ssd/luoxinchen/output/RecoVLM/Qwen2-VL-7B-stage1-v0.0.36/global_step90000-hf
# MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/models/Keye-R1-0528-8B-vit-scratch_v0_8_1
...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.8.6/Stage3/8b/v216/ 
...
nohup mpirun --allow-run-as-root \
	...
	-x TOKENIZERS_PARALLELISM=false \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.8.6/keye_8B_stage3_v216.json  \
