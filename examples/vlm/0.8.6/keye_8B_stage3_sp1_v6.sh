...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.8.6/Stage3/8b/v6/ 
...
nohup mpirun --allow-run-as-root \
	...
	-x TOKENIZERS_PARALLELISM=false \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.8.6/keye_8B_stage3_v1.json  \
		...
		--monitor_image_tokens \
                ...
                --resume_from /mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.8.6/Stage1/8b/v4/step6800/ \
                --resume_from_tag global_step6800 \
		--merge_checkpoint \
