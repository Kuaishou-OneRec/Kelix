...
OUTPUT_DIR=/llm_reco_ssd/zhangzixing/output/RecoVLM/debug_no_vd_video_caption
...
nohup deepspeed --hostfile=/etc/mpi/hostfile_seq --num_nodes=$nnode \
    ...
    --dataset_config /llm_reco/zhangzixing/recovlm/examples/vlm/configs/kwai_video_caption.json \
