...
MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/models/Keye-8B-vit-scratch_0611
# OUTPUT_DIR=/mmu_mllm_hdd_2/linghixin/output/examples/vlm/debug_32B/

# MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/models/Keye-8B-vit0.8.0_2b_v206_0611
MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/models/Keye-8B-demo_hf_vit_rope_nopos_qknorm_0714_v4/
MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/models/Keye-8B-demo_hf_vit_rope
MODEL_DIR=/llm_reco_ssd/zhouyang12/models/Keye-8B-demo_hf_vit_rope
MODEL_DIR=/llm_reco_ssd/zhouyang12/models/Keye-8B-demo_hf_vit_rope_1w_theta
MODEL_DIR=/llm_reco_ssd/zhouyang12/models/Keye-8B-demo_hf_vit_rope_10w_theta
MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/models/Keye-8B-demo_hf_vit_rope_nopos_qknorm_0716_10w_theta_v1/
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.8.6/Stage3/8b/v2/ 
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output/Keye/0.8.7/stage1_0.3.7/v1108
mkdir -p $OUTPUT_DIR
...
nohup mpirun --allow-run-as-root \
	...
	-x TOKENIZERS_PARALLELISM=false \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.8.7/keye_8B_stage3_v1107.json \
