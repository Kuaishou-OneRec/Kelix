...
# MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/models/Keye-8B-demo
MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/models/Keye-8B-demo_128k_v3
...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output/Keye/0.8.7/stage1_0.3.7/v1013
...
# 注意修改实验内容备注
comment="keye_8B_stage3_v7_nobal"
...
nohup mpirun --allow-run-as-root \
	...
	with_nccl_local_env \
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.8.7/keye_8B_stage3_v12.json \
		...
		--monitor_image_tokens \
                ...
                --kml_id 1234 \
                --kml_task_id 345647 \
		--resume_from /mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.9.1/Stage2/8b/formal_0618/step21000 \
		--resume_from_tag global_step21000 \ 
