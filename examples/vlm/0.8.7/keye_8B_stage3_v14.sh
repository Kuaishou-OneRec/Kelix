...
MODEL_DIR=/llm_reco_ssd/zhouyang12/models/Keye-8B-demo_hf_vit_rope_2w_theta
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output/Keye/0.8.7/stage1_0.3.7/v14
...
nohup mpirun --allow-run-as-root \
	...
	with_nccl_local_env \
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.8.7/keye_8B_stage3_v14.json \
		...
		--monitor_image_tokens \
                ...
                --kml_id 1234 \
                --kml_task_id 345647 \
		--resume_from /mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.9.1/Stage3/8b/0.3.11/step3000 \
		--resume_from_tag global_step3000 \ 
