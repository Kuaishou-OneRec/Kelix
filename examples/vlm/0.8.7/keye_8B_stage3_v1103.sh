...
MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/models/Keye-8B-demo_hf_vit_rope_nopos_0714_v1/

MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/models/Keye-8B-demo_hf_vit_rope_nopos_qknorm_0714_v2/
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output/Keye/0.8.7/stage1_0.3.7/v1103
...
nohup mpirun --allow-run-as-root \
	...
	with_nccl_local_env \
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.8.7/keye_8B_stage3_v1102.json \
