...
OUTPUT_DIR=/llm_reco/lingzhixin/exp_outputs/qwen_profile/debug/0.0.1/debug_qwen25_7B_zero2_cutd
...
nohup mpirun --allow-run-as-root -np $np \
        ...
        python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/configs/qwen/qwen_stage2d.json \
