...
OUTPUT_DIR=/llm_reco_ssd/luoxinchen/output/RecoVLM/Qwen2-VL-7B-stage1-v0.0.24 # 使用webdataset实现混合逻辑
...
nohup deepspeed --hostfile=/etc/mpi/hostfile_seq --num_nodes=$nnode \
    ...
    --dataset /llm_reco_ssd/luoxinchen/dataset/coyo-700m-webdataset/coyo-700m-index.json,/llm_reco_ssd/luoxinchen/dataset/datacomp/large/index.json,/llm_reco_ssd/luoxinchen/dataset/cc12m/cc12m-index.json,/llm_reco_ssd/luoxinchen/dataset/mscoco/index.json \
    --max_length 512 \
