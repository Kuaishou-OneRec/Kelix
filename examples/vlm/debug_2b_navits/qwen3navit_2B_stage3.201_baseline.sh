...
OUTPUT_DIR=/mmu_mllm_hdd_2/lingzhixin/output/debug_2b_navits/qwen3navit_2B_stage3.201_debug_baseline
...
nohup mpirun --allow-run-as-root \
	...
	-x TOKENIZERS_PARALLELISM=false \
        ...
        python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.8.0/qwen3navit_2B_stage3.201_nobal.json \
