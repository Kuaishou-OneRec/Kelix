...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output/Keye/Stage2_0.4.4/0.8.0/8b
...
nohup mpirun --allow-run-as-root \
        ...
        python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.0.0_8B_stage2/qwen3navit_8B_stage2_0404.json \
                ...
                --resume_from /llm_reco/liuyang76/train_out/0.0.0/qwen3_8B_stage1_resume_5k/step5000/ \
