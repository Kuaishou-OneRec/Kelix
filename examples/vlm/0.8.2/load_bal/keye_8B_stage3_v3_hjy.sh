...
OUTPUT_DIR=/llm_reco_ssd/huajingyun/model/Keye/8b/Stage3/0.3.6/v0529_balance_true
...
# 注意修改实验内容备注
comment="Keye/8b/Stage3/0.3.6/v0529_balance_true"
...
nohup mpirun --allow-run-as-root \
	...
	-x TOKENIZERS_PARALLELISM=false \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.8.2/keye_8B_stage3_v3_hjy.json \
