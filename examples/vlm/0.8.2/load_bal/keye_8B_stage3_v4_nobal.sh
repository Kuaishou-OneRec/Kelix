...
OUTPUT_DIR=/mmu_mllm_hdd_2/lingzhixin/model/Keye/8b/Stage3/0.3.6/v0530_balance_false_v1
...
nohup mpirun --allow-run-as-root \
	...
	-x TOKENIZERS_PARALLELISM=false \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.8.2/load_bal/keye_8B_stage3_v4_load_nobal.json \
