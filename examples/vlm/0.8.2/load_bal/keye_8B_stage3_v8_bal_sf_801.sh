...
OUTPUT_DIR=/mmu_mllm_hdd_2/lingzhixin/model/Keye/8b/Stage3/0.3.6/v801
...
# 注意修改实验内容备注
comment="keye_8B_stage3_v8_bal_sf"
...
nohup mpirun --allow-run-as-root \
	...
	-x _DATASET_SKIP_MM=SKIP_MM \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.8.2/load_bal/keye_8B_stage3_v8_load_bal_shuffle_800.json \
