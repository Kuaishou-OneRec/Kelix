...
MODEL_DIR=/llm_reco_ssd/zhouyang12/models/Qwen2-1.5B-Instruct-DFN5B-ViT-H-14 # Pretrained model path
OUTPUT_DIR=/llm_reco_ssd/zhangzixing/output2/RecoVLM-dev/Qwen2-VL-1.5B-stage1/0.0.1 # 
...
nohup deepspeed --hostfile=/etc/mpi/hostfile_seq --num_nodes=$nnode \
    ...
    --dataset_config ./examples/vlm/configs/stage1_mix_20250116_parquet.json  \
