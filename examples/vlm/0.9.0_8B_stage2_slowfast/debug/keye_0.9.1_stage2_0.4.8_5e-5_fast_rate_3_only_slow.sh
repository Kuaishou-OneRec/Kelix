...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.9.1/Stage2/8b/slowfast-video-0.1.0-only-slow-freeze-vit
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.9.0_8B_stage2_slowfast/debug/keye_0.9.1_stage2_0.4.8_fast_rate_3_only_slow.json \
		...
		--resume_from /mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.9.1/Stage1/8b/slowfast-video-0.0.1/step9000 \
