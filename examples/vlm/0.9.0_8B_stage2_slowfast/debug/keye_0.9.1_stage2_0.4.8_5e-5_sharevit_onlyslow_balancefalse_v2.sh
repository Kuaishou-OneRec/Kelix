...
MODEL_DIR=/llm_reco_ssd/zhouyang12/models/Keye-8B-demo_hf_vit_rope_slowfast_0608_split_fps_onlyslow
#OUTPUT_DIR=/llm_reco/maosiyang/train_out/0.9.1/keye_2B_stage1/
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.9.1/Stage2/8b/slowfast-video-0.1.0-sharevit-only-slow-v2
...
# 注意修改实验内容备注
comment="version:0.9.1;model_size:8B:H800:384;Stage2:0.4.8,slowfast"
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.9.0_8B_stage2_slowfast/debug/keye_0.9.1_stage2_0.4.8_sharevit_onlyslow_balancefalse_v2.json \
		...
		--resume_from /mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.9.1/Stage1/8b/slowfast-video-0.0.1/step67000 \
                --resume_from_tag global_step67000 \
