...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.9.1/Stage2_5e-5/8b/formal_0618
...
# 注意修改实验内容备注
comment="version:0.9.1;model_size:8B:H800:256;Stage2:0.4.8"
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.9.1/keye_0.9.1_stage2_0.4.8.json \
