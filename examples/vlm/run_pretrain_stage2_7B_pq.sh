...
OUTPUT_DIR=/llm_reco_ssd/luoxinchen/output2/RecoVLM/Qwen2-VL-7B-stage2/0.0.20.20
...
comment="关闭序列并行，修复metrics，合并master测试下parquet,64卡"
...
nohup deepspeed --hostfile=/etc/mpi/hostfile_seq --num_nodes=$nnode \
    ...
    --dataset_config examples/vlm/configs/stage2_parquet.json \
