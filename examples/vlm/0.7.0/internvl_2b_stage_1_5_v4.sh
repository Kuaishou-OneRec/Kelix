...
OUTPUT_DIR=/llm_reco_ssd/luoxinchen/output3/RecoVLM-Base/0.7.0/2b/stage1_5_v4
rm -rf $OUTPUT_DIR
mkdir -p $OUTPUT_DIR
...
nohup mpirun --allow-run-as-root \
		...
		--monitor_image_tokens \
                ...
                --commit_id $git_hash \
		--logging_per_step 10 \
		--resume_from /llm_reco_ssd/luoxinchen/output3/RecoVLM-Base/0.7.0/2b/stage1_v0/step1000 \
