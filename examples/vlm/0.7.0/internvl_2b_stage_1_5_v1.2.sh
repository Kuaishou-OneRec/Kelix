...
MODEL_DIR=/llm_reco_ssd/luoxinchen/output3/RecoVLM-Base/0.7.0/2b/stage1_v0/step12000/global_step12000_torch_ckpt
OUTPUT_DIR=/llm_reco_ssd/luoxinchen/output3/RecoVLM-Base/0.7.0/2b/stage1_5_v1.2
rm -rf $OUTPUT_DIR
mkdir -p $OUTPUT_DIR
...
# 注意修改实验内容备注
comment="run internvl 2b 0.7.0 stage1.5 by lzx, use stage2-0.6.0 data, convert stage1 step12000 ckpt into transformer ckpt"
...
nohup mpirun --allow-run-as-root \
        ...
        python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/configs/0.7.0/2b_internvl_stage2.json  \
                --max_length 21000 \
                --learning_rate 1e-5 \
