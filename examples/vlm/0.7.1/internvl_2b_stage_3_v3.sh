...
OUTPUT_DIR=/llm_reco_ssd/luoxinchen/output3/RecoVLM-Base/0.7.1/2b/stage_3_v3
rm -rf $OUTPUT_DIR
mkdir -p $OUTPUT_DIR
...
nohup mpirun --allow-run-as-root \
        ...
        python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/configs/0.7.0/2b_v0_7_0_internvl_stage3_v3.json  \
                --max_length 21000 \
                --learning_rate 5e-5 \
