...
MODEL_DIR=/llm_reco_ssd/zhouyang12/models/Keye-8B-demo_hf_vit_rope_slowfast_0625_fast_navit_split
#OUTPUT_DIR=/llm_reco/maosiyang/train_out/0.9.1/keye_2B_stage1/

# /llm_reco/lingzhixin/recovlm_qw0510/recovlm/examples/vlm/0.9.0_8B_sf_sp_debug/keye_8B_stage1_video_navit_sp1.sh
OUTPUT_DIR=/mmu_mllm_hdd_2/lingzhixin/output1/Keye/0.9.0_8B_sf_sp_debug/keye_8B_stage1_video_navit_sp104
mkdir -p $OUTPUT_DIR
...
nohup mpirun --allow-run-as-root \
        ...
        python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.9.0_8B_sf_sp_debug/keye_stage1_video_navitd_custom_conf_short.json \
