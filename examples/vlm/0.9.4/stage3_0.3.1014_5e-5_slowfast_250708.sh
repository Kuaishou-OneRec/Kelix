...
sed 's/=1/=8/g' /etc/mpi/hostfile | head -16 > /etc/mpi/hostfile_seq

# MODEL_DIR=/llm_reco_ssd/luoxinchen/output/RecoVLM/Qwen2-VL-7B-stage1-v0.0.36/global_step90000-hf
MODEL_DIR=/mmu_mllm_hdd_2/lingzhixin/models/Keye-8B-demo_hf_vit_rope_slowfast_0703_patch14_qwen3_split
#OUTPUT_DIR=/llm_reco/maosiyang/train_out/0.9.1/keye_2B_stage1/
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.9.4/Stage3_5e-5/8b/stage3_0.3.1014_5e-5_slowfast_250708
...
# 注意修改实验内容备注
comment="version:0.9.1;model_size:8B:H800:512;Stage2:0.4.8"
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.9.4/stage3_0.3.1014_5e-5_slowfast_250708.json \
                --model_class KeyeForConditionalGeneration_vitrope_slowfast_v2 \
