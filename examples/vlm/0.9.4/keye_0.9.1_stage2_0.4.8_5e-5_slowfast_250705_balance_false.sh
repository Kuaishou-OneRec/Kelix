...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output1/Keye/0.9.1/Stage2_5e-5/8b/slowfast_0704_sharevit_only_video_256_balance_false_ml15_test_0708
...
nohup mpirun --allow-run-as-root \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.9.0_8B_stage2_slowfast/keye_0.9.1_stage2_0.4.8_5e-5_slowfast_250705_balance_false.json \
