...
OUTPUT_DIR=/mmu_mllm_hdd_2/lingzhixin/output1/Keye/0.9.1/Stage1/8b/slowfast-video-0.1.0-fast-navit_debug_sp1
mkdir -p $OUTPUT_DIR
...
nohup mpirun --allow-run-as-root \
        ...
        python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.9.0_8B_stage1_slowfast_debug/keye_stage1_video_navitd_custom_conf_short.json \
