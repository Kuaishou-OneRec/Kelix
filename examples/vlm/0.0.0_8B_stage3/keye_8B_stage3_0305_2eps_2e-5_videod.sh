...
OUTPUT_DIR=/mmu_mllm_hdd_2/zhouyang12/output/Keye/keye_8B_stage3_0305_2eps_2e-5_videod/0.8.0/8b
...
nohup mpirun --allow-run-as-root \
	...
	-x _DATASET_SKIP_MM=SKIP_VI \
        ...
        bash -c "bash numa_runner.sh python3 recipes/train_fsdp.py --model_dir $MODEL_DIR \
                ...
                --dataset_config examples/vlm/0.0.0_8B_stage3/keye_8B_stage3_0305d.json \
