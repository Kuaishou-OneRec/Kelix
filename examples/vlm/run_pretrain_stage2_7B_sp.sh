...
OUTPUT_DIR=/llm_reco_ssd/luoxinchen/output2/RecoVLM/Qwen2-VL-7B-stage2/0.0.20.14
...
comment="序列并行基线,64卡,与非sp等效batch_size,metrics从dp_group做reduce,the_cauldron_recaption"
