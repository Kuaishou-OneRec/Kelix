...
OUTPUT_DIR=/llm_reco_ssd/luoxinchen/output2/RecoVLM/Qwen2-VL-7B-stage2/0.0.20.12
...
comment="序列并行基线,64卡,与非sp等效batch_size,测试metrics是否对齐,the_cauldron_recaption"
