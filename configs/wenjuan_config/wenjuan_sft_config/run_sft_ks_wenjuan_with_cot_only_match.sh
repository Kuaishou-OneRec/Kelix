...
OUTPUT_DIR=/llm_reco_ssd/huqigen/model_output/RecoVLM/Qwen2-VL-7B-sft-wenjuan-with-cot-only-match-llm-label/0.0.0.1
...
nohup deepspeed --hostfile=/etc/mpi/hostfile_seq --num_nodes=$nnode \
    ...
    --dataset_config ./examples/vlm/configs/sft_wenjuan_0210_10w_with_cot_only_match_label.json \
