...
OUTPUT_DIR=/llm_reco_ssd/huqigen/model_output/RecoVLM/Qwen2-VL-7B-sft-wenjuan-with-cot-only-match-llm-full-cmt/0.0.0.1
...
# 注意修改实验内容备注
comment="sft 0.0.0.1: stg2 is 0.0.25.5:global_step32000"
...
nohup deepspeed --hostfile=/etc/mpi/hostfile_seq --num_nodes=$nnode \
    ...
    --dataset_config ./examples/vlm/configs/sft_wenjuan_0210_10w_with_cot_only_match_with_cmt.json \
